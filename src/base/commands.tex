...
% fügt Quellcode in den Anhang ein (Parameter: path, language)
\newcommand{\quellcode}[2]{%
	\labeledsubappendix{Listing der Datei #1}%
	\lstinputlisting[language=#2, caption=#1]{Listings/#1}%
}
...
\definecolor{Akzentfarbe}{rgb}{0, 0.28, 0.56} % @todo
