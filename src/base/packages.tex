...
\usepackage{scrhack} % Behebt ein paar Warnungen

% PDF-Optionen -----------------------------------------------------------------
\usepackage{pdfpages}
\pdfminorversion=5 % erlaubt das Einfügen von pdf-Dateien bis Version 1.7, ohne eine Fehlermeldung zu werfen (keine Garantie für fehlerfreies Einbetten!)
\usepackage[ % Informationen über verfügbare Optionen gibt es hier: https://en.wikibooks.org/wiki/LaTeX/Hyperlinks#Customization
  bookmarks,
  bookmarksnumbered,
  bookmarksopen=true,
...
\hypersetup{ % Informationen über verfügbare Optionen gibt es hier: https://en.wikibooks.org/wiki/LaTeX/Hyperlinks#Customization
  pdftitle={\titel},
  pdfauthor={\autorName},
  pdfsubject={\titel},
  pdfkeywords={v\version},
}
